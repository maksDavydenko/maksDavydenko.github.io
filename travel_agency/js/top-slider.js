...
let slides= [
    ...
    slide_1 = {
        background: 'url("img/top-slider/slide-1.jpg")',
    ...
    slide_2 = {
        background: 'url("img/top-slider/slide-2.jpg")',
    ...
    slide_3= {
        background: 'url("img/top-slider/slide-3.jpg")',
    ...
    slide_4 = {
        background: 'url("img/top-slider/slide-4.jpg")',
    ...
    slide_5 = {
        background: 'url("img/top-slider/slide-5.jpg")',
    ...
    slide_6 = {
        background: 'url("img/top-slider/slide-6.jpg")',
    ...
    slide_7 = {
        background: 'url("img/top-slider/slide-7.jpg")',
    ...
    slide_8 = {
        background: 'url("img/top-slider/slide-8.jpg")',
    ...
    slide_9 = {
        background: 'url("img/top-slider/slide-9.jpg")',
    ...
    slide = {
        background: 'url("img/top-slider/slide-10.jpg")',
